Отличная задача! Анализ предоставленной структуры и кода позволяет составить очень подробное и качественное техническое задание (ТЗ) на разработку аналогичного VS Code расширения.
